...
function(EzCMK_AddVendor LIB_GIT_REPO LIB_GIT_TAG TARGET_NAME)
    message(STATUS "Importing ${LIB_GIT_REPO}:${LIB_GIT_TAG} with name ${TARGET_NAME}")
    ...
    set(GIT_PRJ_DIR "${TARGET_NAME}_SOURCE_DIR")
    set(${GIT_PRJ_DIR} "${${GIT_PRJ_DIR}}" PARENT_SCOPE)
endfunction()
