#ifndef EZLIB_HORIZONTALDIVIDER_H
#define EZLIB_HORIZONTALDIVIDER_H

#include "EzLibCommon.h"
#include "ILayoutDivider.h"

/**
 * Represents a basic divider that will divide the size on numDivision rows.
 */
class HorizontalDivider : public ILayoutDivider
{
  public:
    /**
     * Returns the size per element given a physical size. Will return {physicalSize.x, physicalSize.y / numDivisions}
     * @param physicalSize
     * @param numDivisions
     * @return Vec2
     */
...
#endif // EZLIB_HORIZONTALDIVIDER_H
